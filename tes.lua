-- ====================================================================
--                 MOE FISHER - DARK THEME EDITION
--           Fitur: Minimize ke Floating Circle + Logo
-- ====================================================================
...
-- ====================================================================
--                     REMOTE FISHING (DENGAN PROTECTION)
-- ====================================================================
local Events = {}
...
if success and Net then
    ...
    Events = {
        ...
        unequip = {FireServer = function() end},
...
-- Dark theme colors
local Colors = {
    Background = Color3.fromRGB(18, 18, 22),      -- #121216 (dark gelap)
    Surface = Color3.fromRGB(28, 28, 33),         -- #1C1C21 (sedikit lebih terang)
    Primary = Color3.fromRGB(88, 101, 242),       -- #5865F2 (biru discord)
    Success = Color3.fromRGB(67, 181, 129),       -- #43B581 (hijau)
    Danger = Color3.fromRGB(240, 71, 71),         -- #F04747 (merah)
    Warning = Color3.fromRGB(250, 166, 26),       -- #FAA61A (orange)
    Text = Color3.fromRGB(242, 243, 245),         -- #F2F3F5 (putih soft)
    TextMuted = Color3.fromRGB(148, 155, 164),    -- #949BA4 (abu-abu)
    Border = Color3.fromRGB(35, 35, 40),          -- #232328 (garis)
}
...
local function createRoundedFrame(parent, size, pos, color, radius)
    local frame = createFrame(parent, size, pos, color)
...
local function createButton(parent, text, color, pos, size, callback)
